...
function getLatestCommit() {
    window.jQuery.ajax({
            url: "https://api.github.com/repos/mchungames4441/Agar.io-bot/git/refs/heads/master",
            cache: false,
            dataType: "jsonp"
        }).done(function(data) {
            ...
            window.jQuery.get('https://raw.githubusercontent.com/mchungames4441/Agar.io-bot/master/launcher.user.js?' + Math.floor((Math.random() * 1000000) + 1), function(data) {
                ...
                if (latestVersion > myVersion) {
                    update("aposLauncher", "launcher.user.js", "https://github.com/mchungames4441/Agar.io-bot/blob/" + sha + "/launcher.user.js/");
                }
    ...
    if (!d.agarioNoInit) {
        ...
        if (-1 != xa.indexOf("Android")) d.ga && d.ga("send", "event", "MobileRedirect", "PlayStore"), setTimeout(function() {
            ...
            var za, f, G, m, r, X = null,
                ...
                dText = [],
                lines = [],
                names = ["Potato"],["mchungames4441"],["Derp"],["USA"],["Earth"],["Moon"],["Mars"],["Bot"],["Unicorn 101"],["Bert"]
